...
import com.laver.mbook.domain.UserExample;
import com.laver.mbook.domain.UserExample.Criteria;
import com.laver.mbook.mapper.UserMapper;
...
public class UserService implements IUserService {
	...
	public boolean updatePwd(Integer uid, String password, String newPassword) {
		...
		String encode1 = MD5Utils.encode(newPassword);
	...
	@Override
	public boolean checkPhoneIsRegist(String phone) {
		return userMapper.checkPhoneIsRegist(phone) > 0 ? true : false;
	}
