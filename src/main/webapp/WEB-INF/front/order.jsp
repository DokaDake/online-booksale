...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<button type="button" style="border: 0px;background-color: #FFFFFF;" onclick="window.location.href='index.do'" ><img src="<%=basePath %>images/slogan.png" alt="标语"></button>
			...
			<table>
				...
				<tr>
					<td colspan="" rowspan="" headers="">合计金额</td>
						...
						<input id="hiddenSum" name="hiddenSum" type="hidden" value="${sessionScope.cart.totalPrice}" />
						<input id="uname" name="uname" type="hidden" value="${sessionScope.user.uname}" />
						</td>
				</tr>
			</table>
			<div class="button"><a href="cartPage.do">返回购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a id="submit" href="#"><img src="images/orderSub.png"></a>
			</div>
		</form>
		</c:if>
		<c:if test="${sessionScope.cart.totalPrice==0}">
